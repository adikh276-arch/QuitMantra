...
app.use('/quit_assessment', express.static(path.join(__dirname, '../')));
...
app.use('/quit_assessment/api', router);

// Root redirect
app.get('/quit_assessments', (req, res) => res.redirect('/quit_assessments/'));
app.get('/quit_assessment', (req, res) => res.redirect('/quit_assessment/'));

app.get('/quit_assessments/*', (req, res) => res.sendFile(path.join(__dirname, '../index.html')));
app.get('/quit_assessment/*', (req, res) => res.sendFile(path.join(__dirname, '../index.html')));
